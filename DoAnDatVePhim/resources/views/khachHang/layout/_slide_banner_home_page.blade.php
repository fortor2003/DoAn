...
Create trip film.'>
                ...
                <div class="caption slide__video" data-x="0" data-y="0" data-autoplay='true'>
                    <video class="media-element" autoplay="autoplay" preload='none' loop="loop" muted="" src="{{asset('video/53170154.mp4')}}">
                        <source type="video/webm" src="{{asset('video/53170154.webm')}}">
                        <source type="video/mp4" src="{{asset('video/53170154.mp4')}}">
                        <source type="video/ogg" src="{{asset('video/53170154.ogv')}}">
                    </video>
                </div>
